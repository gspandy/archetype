...
public class NameUtil {
     ...
     * 姓
     */
    private static String[] firsNames = {"赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈",
     ...
     * 名
     */
    private static String[] lastNames = {"伟", "伟", "芳", "伟", "秀英", "秀英", "娜", "秀英", "伟",
    ...
    public static String genName() {
        int a = (int) Math.abs(firsNames.length * Math.random());
        int b = (int) Math.abs(lastNames.length * Math.random());
        return firsNames[a] + lastNames[b];
    }
